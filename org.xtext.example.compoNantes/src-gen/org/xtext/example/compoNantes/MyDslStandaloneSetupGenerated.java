...
public class MyDslStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new org.xtext.example.compoNantes.MyDslRuntimeModule());
	}
	
	public void register(Injector injector) {
	if (!EPackage.Registry.INSTANCE.containsKey("http://www.xtext.org/example/compoNantes/MyDsl")) {
		EPackage.Registry.INSTANCE.put("http://www.xtext.org/example/compoNantes/MyDsl", org.xtext.example.compoNantes.myDsl.MyDslPackage.eINSTANCE);
	}
