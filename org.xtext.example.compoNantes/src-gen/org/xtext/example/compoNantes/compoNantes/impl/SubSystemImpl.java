 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.compoNantes.compoNantes.impl.SubSystemImpl#getComponents <em>Components</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SubSystemImpl extends TrucImpl implements SubSystem
{
  ...
  {
    return CompoNantesPackage.Literals.SUB_SYSTEM;
  }
  ...
  public EList<Component> getComponents()
  {
    if (components == null)
    {
      components = new EObjectContainmentEList<Component>(Component.class, this, CompoNantesPackage.SUB_SYSTEM__COMPONENTS);
    }
    return components;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case CompoNantesPackage.SUB_SYSTEM__COMPONENTS:
