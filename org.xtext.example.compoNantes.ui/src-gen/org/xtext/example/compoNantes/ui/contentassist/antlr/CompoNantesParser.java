		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getTrucAccess().getAlternatives(), "rule__Truc__Alternatives");
					...
					put(grammarAccess.getSubSystemAccess().getComponentsAssignment_3(), "rule__SubSystem__ComponentsAssignment_3");
					put(grammarAccess.getSubSystemAccess().getInterfacesAssignment_4(), "rule__SubSystem__InterfacesAssignment_4");
					put(grammarAccess.getSubSystemAccess().getPortsAssignment_5(), "rule__SubSystem__PortsAssignment_5");
